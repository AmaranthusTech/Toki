...
def _resolve_leap_span_pos_for_month_naming(
    ...
    *,
    ...
    if len(zeros) >= 2:
        raise RuntimeError(f"zero-zhongqi spans>=2 found (boundary mismatch?): {zeros}")
